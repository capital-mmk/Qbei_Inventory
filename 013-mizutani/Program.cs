...
namespace _013_mizutani
{
    static class Program
    {
        ...
        private static void ReadData()
        {
            ...
            {
                string janCode = dt013.Rows[0]["JANコード"].ToString();
                string orderCode = dt013.Rows[0]["発注コード"].ToString();
                fun.Qbei_ErrorInsert(13, fun.GetSiteName("013"), ex.Message, janCode, orderCode, 1, DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"), "013");
                    ...
                    try
                    {
                        ...
                        else
                        {
                            if (chrome.FindElement(By.Id("gvSyohin_ctl02_zaikojokyo")) == null && (chrome.FindElement(By.XPath("div[3]/div[6]/div/table/tbody/tr[2]")) == null))
                            {
                                ...
                                fun.WriteLog("Access Denied! " + entity.janCode + " " + entity.orderCode, "013-");
                                Environment.Exit(0);
                            }
                            else
                            {
