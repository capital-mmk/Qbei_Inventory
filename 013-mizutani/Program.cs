...
namespace _013_mizutani
{
    static class Program
    {
        ...
        private static readonly TimeSpan TIMEOUT = new TimeSpan(0, 0, 0);
        ...
        {            
            ...
            chrome = new ChromeDriver(service, option, TimeSpan.FromMinutes(2));
            wait = new Wait.WebDriverWait(chrome, TIMEOUT);

            //chrome.AllowNavigation = true;
            chrome.Url = "https://www.ordermz.jp/weborder";
            ...
            else
            {
                ...
                //chrome.Url = fun.url + "/SyohincodeOrder.aspx";
        ...
        private static void ItemSearch()
        {
            ...
            try
            {
                ...
                if (i < dt013.Rows.Count - 1)
                {
                    ...
                    IWebElement element = chrome.FindElement(By.Id("gvSyohin_ctl02_syohincode"));
                    element.SendKeys(orderCode);
                    Actions actionObject = new Actions(chrome);
                    actionObject.SendKeys(OpenQA.Selenium.Keys.Tab).Perform();
                    ItemProcessing();
                }
        ...
        private static void ItemProcessing()
        {
            ...
            chrome.FindElement(By.CssSelector("tr:nth-child(2) td:last-child input[value=クリア]")).Click();
            Thread.Sleep(2000);
            ItemSearch();
        }
