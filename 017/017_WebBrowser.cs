    ...
    public partial class frm017 : Form
    {
        ...
        public void StartRun()
        {
            try
            {
                ...
                int dtcount = Convert.ToInt32(dt017.Rows.Count);
                ReadData();
            }
            catch { }
        }
        ...
        private void webBrowser1_Start(object sender, WebBrowserDocumentCompletedEventArgs e)
        {
            ...
            {
                fun.Qbei_ErrorInsert(17, fun.GetSiteName("017"), ex.Message, dt017.Rows[0]["JANコード"].ToString(), dt017.Rows[0]["発注コード"].ToString(), 4, DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"), "012");
                fun.WriteLog(ex.Message + dt017.Rows[0]["発注コード"].ToString(), "017-");
                Application.Exit();
                Environment.Exit(0);
            }
        }
        ...
        private void webBrowser1_Login(object sender, WebBrowserDocumentCompletedEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    //string ordercode = "4573214155867";
            ...
            {
                fun.Qbei_ErrorInsert(17, fun.GetSiteName("017"), ex.Message, dt017.Rows[0]["JANコード"].ToString(), dt017.Rows[0]["発注コード"].ToString(), 4, DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"), "017");
                fun.WriteLog(ex.Message + dt017.Rows[0]["発注コード"].ToString(), "017-");
                Application.Exit();
                Environment.Exit(0);
            }
        ...
        private void webBrowser1_ItemSearch(object sender, WebBrowserDocumentCompletedEventArgs e)
        {
                ...
                if (!string.IsNullOrWhiteSpace(entity.orderCode))
                {
                    ...
                    else
                    {
...

                        {
                            ...
                            fun.WriteLog("Access Denied! " + entity.orderCode, "017--");
                            Application.Exit();
                        }
                        else
                        {
                            ...
                            {
                                //if (((entity.qtyStatus.Equals("empty")) && (entity.stockDate.Equals("2100-01-01"))) || ((entity.qtyStatus.Equals("empty")) && (entity.stockDate.Equals(" "))) || ((entity.stockDate.Equals(" ")) && (entity.qtyStatus.Equals("inquiry"))) || ((entity.stockDate.Equals("2018-02-28")) && (entity.qtyStatus.Equals("inquiry"))))
                                ...
                                // if ((entity.qtyStatus.Equals("empty") && (entity.stockDate.Equals("2100-01-01") || entity.stockDate.Equals("2100-02-01"))) || entity.qtyStatus.Equals("inquiry") || ((entity.stockDate.Equals(todaydate) && entity.qtyStatus.Equals("inquiry"))) || ((entity.stockDate.Equals("2018-02-28") && entity.qtyStatus.Equals("inquiry"))))
                                {
            ...
            catch (Exception ex)
            {
                ...
                fun.WriteLog(ex.Message + entity.orderCode, "17-");
            }
        }
        private void instance_NavigateError(object pDisp, ref object URL, ref object Frame, ref object StatusCode, ref bool Cancel)
        {
            fun.Qbei_ErrorInsert(17, fun.GetSiteName("017"), "Access Denied!", dt017.Rows[i]["JANコード"].ToString(), dt017.Rows[i]["発注コード"].ToString(), 4, DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"), "017");
            fun.WriteLog(StatusCode.ToString() + " " + dt017.Rows[i]["発注コード"].ToString(), "017--");
            Application.Exit();
        }
    }
}
