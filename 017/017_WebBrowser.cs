        ...
        private void webBrowser1_ItemSearch(object sender, WebBrowserDocumentCompletedEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(entity.orderCode))
                {
                    ...
                    //if (body.Contains("申し訳ございません。"))//<remark Edit Logic for Check to Ordercode 2021/15/11 />
                    if (body.Contains("申し訳ございません。") || entity.orderCode.Contains(@"\"))
                    {
                        //<remark Add Logic for Check to Ordercode 2021/15/11 Start>
                        if (entity.orderCode.Contains(@"\"))
                        {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    //entity.qtyStatus = qty.Contains("欠品") || qty.Contains("完売") || qty.Contains("終了") || qty.Contains("取寄") || qty.Contains("入荷待ち") || qty.Contains("お問") || qty.Contains("取り寄せ") || qty.Contains("わずか") || qty.Contains("僅か") || qty.Contains("在庫僅か") || qty.Contains("未定") || qty.Contains("予約受付中") || qty.Contains("予約") ? "empty" : qty.Contains("有り") || qty.Contains("あり") ? "good" : "invalid status code";//<remark Stockdate Logic　編集　2021/06/28 />
                                    //entity.qtyStatus = qty.Contains("予約") ? "inquiry" : qty.Contains("欠品") || qty.Contains("完売") || qty.Contains("終了") || qty.Contains("取寄") || qty.Contains("入荷待ち") || qty.Contains("お問") || qty.Contains("取り寄せ") ||  qty.Contains("未定") || qty.Contains("予約受付中")  ? "empty" : qty.Contains("わずか") || qty.Contains("僅か") || qty.Contains("在庫僅か") ? "small" : qty.Contains("有り") || qty.Contains("あり") ? "good" : "invalid status code";//<remark ロジックの変更　2022/01/19 />
                                    entity.qtyStatus = qty.Contains("で入荷") ? "inquiry" : qty.Contains("欠品") || qty.Contains("完売") || qty.Contains("終了") || qty.Contains("取寄") || qty.Contains("入荷待ち") || qty.Contains("お問") || qty.Contains("取り寄せ") || qty.Contains("未定") || qty.Contains("予約受付中") || qty.Contains("予約") ? "empty" : qty.Contains("わずか") || qty.Contains("僅か") || qty.Contains("在庫僅か") ? "small" : qty.Contains("有り") || qty.Contains("あり") ? "good" : "unknown status";//<remark ロジックの変更　2022/12/26 />
                                    if (stockDatePath == "")
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            //entity.stockDate = qty.Contains("完売") || qty.Contains("終了") || qty.Contains("欠品") || qty.Contains("取寄") || qty.Contains("入荷待ち") || qty.Contains("お問") || qty.Contains("取り寄せ") || qty.Contains("僅か") || qty.Contains("わずか") || qty.Contains("在庫僅か") || qty.Contains("未定") || qty.Contains("予約受付中") || qty.Contains("予約") ? "2100-02-01" : qty.Contains("有り") || qty.Contains("あり") ? "2100-01-01" : "unknown date";//<remark Stockdate Logic　編集　2021/06/28 />
                                            //entity.stockDate = qty.Contains("完売") || qty.Contains("終了") || qty.Contains("欠品") || qty.Contains("取寄") || qty.Contains("入荷待ち") || qty.Contains("お問") || qty.Contains("取り寄せ") || qty.Contains("未定") || qty.Contains("予約受付中") || qty.Contains("予約") ? "2100-02-01" : qty.Contains("有り") || qty.Contains("あり") || qty.Contains("僅か") || qty.Contains("わずか") || qty.Contains("在庫僅か") ? "2100-01-01" : "unknown date";//<remark ロジックの変更　2022/01/19 />
                                            entity.stockDate = qty.Contains("完売") || qty.Contains("終了") || qty.Contains("欠品") || qty.Contains("取寄") || qty.Contains("入荷待ち") || qty.Contains("お問") || qty.Contains("取り寄せ") || qty.Contains("未定") || qty.Contains("予約受付中") || qty.Contains("予約") ? "2100-02-01" : qty.Contains("有り") || qty.Contains("あり") || qty.Contains("僅か") || qty.Contains("わずか") || qty.Contains("在庫僅か") || qty.Contains("で入荷") ? "2100-01-01" : "unknown date";//<remark ロジックの変更　2022/12/26 />
                                        }
                                    }
                                    else
                                    {
                                        ...
                                        //entity.stockDate = qty.Contains("完売") || qty.Contains("終了") || qty.Contains("欠品") || qty.Contains("取寄") || qty.Contains("入荷待ち") || qty.Contains("お問") || qty.Contains("取り寄せ") || qty.Contains("未定") || qty.Contains("予約受付中") || qty.Contains("予約") ? "2100-02-01" : qty.Contains("わずか") || qty.Contains("有り") || qty.Contains("あり") || qty.Contains("僅か") ? DateTime.Now.ToString("yyyy/MM/dd") : "unknown date";//<remark Stockdate Logic　編集　2021/06/28>
                                        entity.stockDate = qty.Contains("完売") || qty.Contains("終了") || qty.Contains("欠品") || qty.Contains("取寄") || qty.Contains("入荷待ち") || qty.Contains("お問") || qty.Contains("取り寄せ") || qty.Contains("未定") || qty.Contains("予約受付中") || qty.Contains("予約") ? "2100-02-01" : qty.Contains("わずか") || qty.Contains("有り") || qty.Contains("あり") || qty.Contains("僅か") || qty.Contains("で入荷") ? DateTime.Now.ToString("yyyy/MM/dd") : "unknown date";//<remark Stockdate Logic　編集　2021/12/26>
