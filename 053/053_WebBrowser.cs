...
namespace _053
{
    public partial class frm053 : Form
    {
        ...
        public void StartRun()
        {
            ...
            catch (Exception e) { fun.WriteLog(e.Message.ToString(), "053--"); }
        }
        ...
        private void webBrowser1_Start(object sender, WebBrowserDocumentCompletedEventArgs e)
        {
            ...
            {
                fun.Qbei_ErrorInsert(53, fun.GetSiteName("053"), ex.Message, dt053.Rows[0]["JANコード"].ToString(), dt053.Rows[0]["発注コード"].ToString(), 1, DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"), "053");
                fun.WriteLog(ex.Message + dt053.Rows[0]["発注コード"].ToString(), "053--");
                Application.Exit();
                Environment.Exit(0);
            }
        }
        ...
        {
            fun.Qbei_ErrorInsert(53, fun.GetSiteName("053"), "Access Denied!", dt053.Rows[i]["JANコード"].ToString(), dt053.Rows[i]["発注コード"].ToString(), 4, DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"), "053");
            fun.WriteLog(StatusCode.ToString() + " " + dt053.Rows[i]["発注コード"].ToString(), "053--");
            Application.Exit();
        }
    }
}