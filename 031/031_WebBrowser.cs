            ...
            else
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        entity.qtyStatus = qty.Contains("○") ? "good" : qty.Contains("△") || qty.Contains("▲") ||fun.IsNumber(qty)? "small" : qty.Contains("予約受付中") || qty.Contains("在庫なし") || qty.Contains("受付終了") ? "empty" : "unknown status";//<remark ロジックの変更　2022/01/21 />
                        ...
                        entity.stockDate = qty.Contains("○") || qty.Contains("△") || qty.Contains("▲")  || fun.IsNumber(qty) ? "2100-01-01" :  qty.Contains("予約受付中") || qty.Contains("在庫なし") || qty.Contains("受付終了") ? "2100-02-01" : "unknown date";//<remark ロジックの変更　2022/01/21 />
