                            ...
                            if (i < Lastrow)
                            {
                                ...
                                if (!string.IsNullOrWhiteSpace(entity.orderCode))
                                {
                                            ...
                                            if (chrome.FindElement(By.XPath("/html/body/center/center/div/div[2]/div[2]/table/tbody/tr[1]/td[3]/form[2]/div/div[1]/div[2]/div[1]/table/tbody/tr[6]/td/div/table[2]/tbody")).Text.Contains(entity.orderCode))
                                            {
                                                ...
                                                for (int i = 1; i <= c; i++)
                                                {
                                                    if (chrome.FindElement(By.XPath("/html/body/center/center/div/div[2]/div[2]/table/tbody/tr[1]/td[3]/form[2]/div/div[1]/div[2]/div[1]/table/tbody/tr[6]/td/div/table[2]/tbody/tr[" + (i) + "]/th")).Text.Contains(entity.orderCode))
                                                    {
                                                        ...
                                                        if (stock.Contains("個") && entity.qtyStatus == "unknown status")
                                                        {
                                                            string item = stock.Replace("個", String.Empty).Replace("入荷未定", String.Empty).Replace("在庫限り", String.Empty).Replace(" ", String.Empty);
                                            ...
                                            else
                                            {
                                                ...
                                                for (int i = 1; i <= a; i++)
                                                {
                                                    if (chrome.FindElement(By.XPath("/html/body/center/center/div/div[2]/div[2]/table/tbody/tr[1]/td[3]/form[2]/div/div[1]/div[2]/div[1]/table/tbody/tr[7]/td/div/table[2]/tbody/tr[" + (i) + "]/th")).Text.Contains(entity.orderCode))
                                                    {
                                                        ...
                                                        entity.True_Quantity = stock;
                                                        entity.qtyStatus = stock.Contains("○") || stock.Contains("〇") ? "good" : stock.Contains("個") && stock.Contains("残り僅か") ? "small" : stock.Contains("個") && stock.Contains("入荷予定") ? "good" : stock.Contains("在庫在") || stock.Contains("在庫有") ? "small" : stock.Contains("在庫なし") ? "empty" : "unknown status";

                                                        if (stock.Contains("個") && entity.qtyStatus == "unknown status")
                                                        {
                                                            string item = stock.Replace("個", String.Empty).Replace("入荷未定", String.Empty).Replace("在庫限り", String.Empty).Replace(" ", String.Empty).Replace("納期未定/入荷次第出荷", String.Empty);
                                                        ...
                                                        else if (stock.Contains("入荷予定"))
                                                        {
                                                            entity.stockDate = stock.Replace("上旬", "10").Replace("中旬", "20").Replace("下旬", "30").Replace("入荷予定", String.Empty).Replace("/", "-").Replace("年", "-").Replace("月", "-").Replace("日", String.Empty).Replace("在庫なし ", String.Empty); // .Replace("個", String.Empty) .Replace(" ", String.Empty)
                                    ...
                                    label:
                                        ...
                                        // <remark try catch logic change 2025-12-22 >
                                        try
                                        {
                                            int c = chrome.FindElements(By.XPath("/html/body/center/center/div/div[2]/div[2]/table/tbody/tr[1]/td[3]/form[2]/div/div[1]/div[2]/div[1]/table/tbody/tr[6]/td/div/table[2]/tbody/tr")).Count();
                                        ...
                                        {
                                            int c = chrome.FindElements(By.XPath("/html/body/center/center/div/div[2]/div[2]/table/tbody/tr[1]/td[3]/form[2]/div/div[1]/div[2]/div[1]/table/tbody/tr[7]/td/div/table[2]/tbody/tr")).Count();
                                            for (int i = 1; i <= c; i++)
                                            {
                                                if (chrome.FindElement(By.XPath("/html/body/center/center/div/div[2]/div[2]/table/tbody/tr[1]/td[3]/form[2]/div/div[1]/div[2]/div[1]/table/tbody/tr[7]/td/div/table[2]/tbody/tr[" + (i) + "]/th")).Text.Contains(entity.orderCode))
                                                {
