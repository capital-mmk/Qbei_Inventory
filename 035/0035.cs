        ...
        private void webBrowser1_ItemSearch(object sender, WebBrowserDocumentCompletedEventArgs e)
        {
            try
            {
                ...
                if (i < dt035.Rows.Count - 1)
                {
                    ...
                    //webBrowser1.Refresh();
                    //string ordercode = fun.ReplaceOrderCode(dt035.Rows[++i]["発注コード"].ToString(), new string[] { "在庫処分/inquiry/", "在庫処分/empry/", "-", "在庫処分/good/", "在庫処分/small/", "在庫処分/empty/", "バラ注文できない為発注禁止/" });
                    webBrowser1.Navigate("https://intertecinc.jp/ecuser/item/itemDetail?itemCd=" + ordercode);
