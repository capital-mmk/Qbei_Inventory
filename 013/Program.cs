        ...
        public static void StartRun()
        {
            ...
            try
            {
                ...
                using (IWebDriver chrome = new ChromeDriver(service, chromeOptions, TimeSpan.FromMinutes(3)))
                {
                    ...
                    try
                    {
                        ...
                        for (i = 0; i < Lastrow; i++)
                        {
                            if (i < Lastrow)
                            {
                                ...
                                entity.orderCode = dt013.Rows[i]["発注コード"].ToString();
                                ...
                                if (!string.IsNullOrWhiteSpace(entity.orderCode))
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (entity.qtyStatus != "unknown status")
                                        {
                                            ...
                                            {
                                                fun.Qbei_ErrorInsert(13, fun.GetSiteName("013"), "entity.qtyStatus is null!", entity.janCode, entity.orderCode, 5, DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"), "013");
                                            }
                                        }
                                        else
                                        {
                                            fun.Qbei_ErrorInsert(13, fun.GetSiteName("013"), "entity.qtyStatus is unknown status!", entity.janCode, entity.orderCode, 5, DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"), "013");
                                        }
                                    }
                                }
                                else
                                {
                                    fun.Qbei_ErrorInsert(13, fun.GetSiteName("013"), "Order Code Not Found!", entity.janCode, entity.orderCode, 3, DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"), "013");
                                }
                            }
                        }
                        qe.site = 13;
                    ...
                    {
                        string janCode = dt013.Rows[i]["JANコード"].ToString();
                        ordercode = dt013.Rows[i]["発注コード"].ToString();
                        fun.Qbei_ErrorInsert(13, fun.GetSiteName("013"), ex.Message, janCode, ordercode, 4, DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"), "013");
                        fun.WriteLog(ex, "013-", janCode, ordercode);
                    }
                }
            }
            catch (Exception ex)
