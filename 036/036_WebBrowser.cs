                            ...
                            if (!webBrowser1.Url.ToString().Equals(entity.purchaseURL))
                                    ...
                                    if (Table.InnerText.Contains("在庫状況"))
                                    {
                                        ...
                                        while(d_count<=b.Count-1)
                                        {
                                          if (b[d_count].InnerText == "入荷時期")
                                         {
                                            ...
                                            //entity.stockDate = a[d_count].InnerText.Replace("'", string.Empty);<//remark Add Logic for Stockdate 2022/10/11 />
                                            entity.stockDate = a[d_count].InnerText.Replace("'", string.Empty).Replace("’", string.Empty);
                                            break;
                                         }
                                           ++d_count;
                                        }
                                ...
                                else
                                {
                                    ...
                                    else if (entity.stockDate.Contains("年") && entity.stockDate.Contains("月"))
                                    {
                                        ...
                                        //<remark Add Logic for Take Year 2021/12/09 Start>
                                        if(YIndex < 4)
                                        {
