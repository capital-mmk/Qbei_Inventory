    ...
    public partial class frm087 : Form
    {
        ...
        public void StartRun()
        {
            try
            {
               ...
               // dt087 = fun.GetOrderData(dt087, "http://www.dirtfreak.co.jp/cycledealer/search_form.php?dfhinbanA=&dfhinbanB=&textsearch=&cataloghinban=", "087", "&submitall=submit"); // 2023/04/24 updated by ct   
                ...
                else
                {
                    try
                    {
                        ...
                        else
                        {
                            ...
                            entity.qtyStatus = qtypath.Equals("◎") ? "good" : qtypath.Equals("○") || qtypath.Equals("▲") ? "small" : qtypath.Equals("×") || qtypath.Equals("※") ? "empty" :  "invalid status code";//<remark ロジックの変更　2022/01/21 />
                            ...
                            entity.stockDate = qtypath.Equals("◎") || qtypath.Equals("○") || qtypath.Equals("▲") ? "2100-01-01" : qtypath.Equals("×") || qtypath.Equals("※") ? "2100-02-01" : "unknown date";//<remark ロジックの変更　2022/01/21 />
